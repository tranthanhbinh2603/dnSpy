# dnSpy - [Latest release](https://github.com/VNGhostMans/dnSpy/releases)
...
First you need to Clean Solution (Realease/AnyCPU), then Build Solution (Realease/AnyCPU), finally REBUILD dnSpy (x86 & x64).
